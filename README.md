...
| oh-my-posh | The most customisable and low-latency cross platform/shell prompt renderer | https://github.com/JanDeDobbeleer/oh-my-posh | Shell, Development Tools |
| hiddify-next | Multi-platform auto-proxy client, supporting Sing-box, X-ray, TUIC, Hysteria, Reality, Trojan, SSH etc. It’s an open-source, secure and ad-free. | https://github.com/hiddify/hiddify-next | Networking and Communication, Security and Privacy |
| ToonCrafter | a research paper for generative cartoon interpolation | https://github.com/ToonCrafter/ToonCrafter | AI and Machine Learning |
| firecrawl | 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API. | https://github.com/mendableai/firecrawl | AI and Machine Learning, Web Development |
| screenshot-to-code | Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue) | https://github.com/abi/screenshot-to-code | Web Development, React |
| AniTalker |  | https://github.com/X-LANCE/AniTalker |  |
| music2video | Making an AI-generated music video from any song with Wav2CLIP and VQGAN-CLIP | https://github.com/joeljang/music2video | AI and Machine Learning, Media Tools |
| mugen | A command-line music video generator based on rhythm | https://github.com/scherroman/mugen | Development Tools, CLI tool |
| VQGAN-CLIP | Just playing with getting VQGAN+CLIP running locally, rather than having to use colab. | https://github.com/nerdyrodent/VQGAN-CLIP | AI and Machine Learning, Media Tools |
| LLMs-from-scratch | Implementing a ChatGPT-like LLM in PyTorch from scratch, step by step | https://github.com/rasbt/LLMs-from-scratch | AI and Machine Learning, Python |
| Text2Video-Zero | [ICCV 2023 Oral] Text-to-Image Diffusion Models are Zero-Shot Video Generators | https://github.com/Picsart-AI-Research/Text2Video-Zero | AI and Machine Learning, Media Tools |
| easydiffusion | Easiest 1-click way to create beautiful artwork on your PC using AI, with no tech knowledge. Provides a browser UI for generating images from text prompts and images. Just enter your text prompt, and see the generated image. | https://github.com/easydiffusion/easydiffusion | AI and Machine Learning, Media Tools |
| IP-Adapter | The image prompt adapter is designed to enable a pretrained text-to-image diffusion model to generate images with image prompt. | https://github.com/tencent-ailab/IP-Adapter | AI and Machine Learning, Media Tools |
| yabridge | A modern and transparent way to use Windows VST2, VST3 and CLAP plugins on Linux | https://github.com/robbert-vdh/yabridge | System Management, Development Tools |
| LinVst | Linux Windows vst wrapper/bridge | https://github.com/osxmidi/LinVst | System Management, Development Tools |
| litgpt | 20+ high-performance LLMs with recipes to pretrain, finetune and deploy at scale. | https://github.com/Lightning-AI/litgpt | AI and Machine Learning, LLM Tools |
| dify | Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production. | https://github.com/langgenius/dify | AI and Machine Learning, LLM Tools |
| qmidiarp | Linux MIDI arpeggiator, sequencer and LFO for ALSA and JACK | https://github.com/emuse/qmidiarp | Media Tools, Music Production |
| run_scaled | Run an X application scaled via xpra. Useful on hidpi screens. | https://github.com/kaueraal/run_scaled | System Management |
| Mamba | Virtual Midi keyboard and Midi Live Looper for Jack Audio Connection Kit | https://github.com/brummer10/Mamba | Media Tools, Music Production |
| seq66 | Seq66: Seq24-based live MIDI looper/editor. v. 0.99.12 2024-01-13. NSM support; Linux/Windows/FreeBSD; PDF user manual. Help access to tutorial and PDF. Beta code in portfix branch. | https://github.com/ahlstromcj/seq66 | Media Tools, Music Production |
| GPT-SoVITS | 1 min voice data can also be used to train a good TTS model! (few shot voice cloning) | https://github.com/RVC-Boss/GPT-SoVITS | AI and Machine Learning, TTS |
| big-AGI | Generative AI suite powered by state-of-the-art models and providing advanced AI/AGI functions. It features AI personas, AGI functions, multi-model chats, text-to-image, voice, response streaming, code highlighting and execution, PDF import, presets for developers, much more. Deploy on-prem or in the cloud. | https://github.com/enricoros/big-AGI | AI and Machine Learning, LLM Tools |
| SaaS-Boilerplate | 🚀🎉📚 SaaS Boilerplate built with Next.js + Tailwind CSS + Shadcn UI + TypeScript. ⚡️ Full-stack React application with Auth, Multi-tenancy, Roles & Permissions, i18n, Landing Page, DB, Logging, Testing | https://github.com/ixartz/SaaS-Boilerplate | Web Development, React, Typescript |
| refine | A React Framework for building internal tools, admin panels, dashboards & B2B apps with unmatched flexibility. | https://github.com/refinedev/refine | Web Development, React |
| llamafile | Distribute and run LLMs with a single file. | https://github.com/Mozilla-Ocho/llamafile | LLM Tools |
| VoiceCraft | Zero-Shot Speech Editing and Text-to-Speech in the Wild | https://github.com/jasonppy/VoiceCraft | TTS |
...
| pytesseract | A Python wrapper for Google Tesseract | https://github.com/madmaze/pytesseract | Python |
...
| autogen | A programming framework for agentic AI. Discord: https://aka.ms/autogen-dc. Roadmap: https://aka.ms/autogen-roadmap | https://github.com/microsoft/autogen | AI and Machine Learning, Framework |
...
| cog | Containers for machine learning | https://github.com/replicate/cog | AI and Machine Learning |
...
| QGIS | QGIS is a free, open source, cross platform (lin/win/mac) geographical information system (GIS) | https://github.com/qgis/QGIS | Data Management, GIS |
...
| AudioLDM | AudioLDM: Generate speech, sound effects, music and beyond, with text. | https://github.com/haoheliu/AudioLDM | AI and Machine Learning, TTS |
...
| llama_index | LlamaIndex is a data framework for your LLM applications | https://github.com/run-llama/llama_index | AI and Machine Learning |
...
| pypika | PyPika is a python SQL query builder that exposes the full richness of the SQL language using a syntax that reflects the resulting query. PyPika excels at all sorts of SQL queries but is especially useful for data analysis. | https://github.com/kayak/pypika | Python, Data Management |
...
| awesome-blender | 🪐 A curated list of awesome Blender addons, tools, tutorials; and 3D resources for everyone. | https://github.com/agmmnn/awesome-blender | Media Tools |
...
| MANSPIDER | Spider entire networks for juicy files sitting on SMB shares. Search filenames or file content - regex supported! | https://github.com/blacklanternsecurity/MANSPIDER | Security and Privacy |
...
| free-midi-chords | A collection of free MIDI chords and progressions ready to be used in your DAW, Akai MPC, or Roland MC-707/101 | https://github.com/ldrolez/free-midi-chords | Music Production, MIDI |
...
| svelte | Cybernetically enhanced web apps | https://github.com/sveltejs/svelte | Web Development, JavaScript |
...
| typesense | Open Source alternative to Algolia + Pinecone and an Easier-to-Use alternative to ElasticSearch ⚡ 🔍 ✨ Fast, typo tolerant, in-memory fuzzy Search Engine for building delightful search experiences | https://github.com/typesense/typesense | Data Management |
...
| dive | A tool for exploring each layer in a docker image | https://github.com/wagoodman/dive | Docker, Development Tools |
...
| CandleLight | Indicator showing candle stick patterns and breakouts of S&R | https://github.com/erwin-beckers/CandleLight | Financial Tools |
...
| catalyst | An Algorithmic Trading Library for Crypto-Assets in Python | https://github.com/scrtlabs/catalyst | Python, Financial Tools |
...
| MailHog | Web and API based SMTP testing | https://github.com/mailhog/MailHog | Development Tools, SMTP |
...
| facifier | An emotion and gender detector based on facial features, built with Python and OpenCV | https://github.com/chandraseta/facifier | AI and Machine Learning, Python, OpenCV |
...
| linuxband | GUI front-end for MMA (Musical MIDI Accompaniment) | https://github.com/noseka1/linuxband | Media Tools |
...
| docker-pyinstaller | PyInstaller for Linux and Windows inside Docker | https://github.com/cdrx/docker-pyinstaller | DevOps, Docker |
| garden.iconfonts   | Simple helper functions to make easier to use icon fonts in Labels and derived widgets | https://github.com/kivy-garden/garden.iconfonts | Web Development, Python |
| rtmidi2           | python bindings to rtmidi allowing to listen to multiple ports simultaneously | https://github.com/gesellkammer/rtmidi2 | Python, Library |
| websockify         | Websockify is a WebSocket to TCP proxy/bridge. This allows a browser to connect to any application/server/service. | https://github.com/novnc/websockify | Networking and Communication, Web Development |
| docker-android     | Android in docker solution with noVNC supported and video recording | https://github.com/budtmo/docker-android | Mobile Development, Docker |
| WatermelonDB      | 🍉 Reactive & asynchronous database for powerful React and React Native apps ⚡️ | https://github.com/Nozbe/WatermelonDB | React, Web Development |
| dbus-native       | D-bus protocol client and server for node.js written in native javascript | https://github.com/sidorares/dbus-native | JavaScript, Networking and Communication |
| jailing           | super-easy chroot jail builder/runner for Linux | https://github.com/kazuho/jailing | System Management, Shell |
| web-segmentation-evaluation | Tools for web page segmentation evaluation | https://github.com/asanoja/web-segmentation-evaluation | Data Management, Web Development |
| sdalg             | Web page segmentation and noise removal | https://github.com/nik0spapp/sdalg | Data Management, Web Development |
| spacyr | R wrapper to spaCy NLP | https://github.com/quanteda/spacyr | Natural Language Processing |
| clearnlp-guidelines | Guidelines. | https://github.com/clir/clearnlp-guidelines | Educational Resources |
| allennlp | An open-source NLP research library, built on PyTorch. | https://github.com/allenai/allennlp | AI and Machine Learning |
| autokeras | AutoML library for deep learning | https://github.com/keras-team/autokeras | AI and Machine Learning |
| jgrapht | Master repository for the JGraphT project | https://github.com/jgrapht/jgrapht | Data Management |
| hyperopt-sklearn | Hyper-parameter optimization for sklearn | https://github.com/hyperopt/hyperopt-sklearn | AI and Machine Learning |
| hyperopt | Distributed Asynchronous Hyperparameter Optimization in Python | https://github.com/hyperopt/hyperopt | AI and Machine Learning |
| tips | Most commonly used git tips and tricks. | https://github.com/git-tips/tips | Development Tools |
| dask | Parallel computing with task scheduling | https://github.com/dask/dask | Data Management |
| signale | Highly configurable logging utility | https://github.com/klaudiosinani/signale | Development Tools |
| morpheus | Morpheus - Automating Ettercap TCP/IP (MITM-hijacking Tool) | https://github.com/r00t-3xp10it/morpheus | Security and Privacy, Shell |
| auto-sklearn | Automated Machine Learning with scikit-learn | https://github.com/automl/auto-sklearn | AI and Machine Learning, Python |
| audit-ai | detect demographic differences in the output of machine learning models or other assessments | https://github.com/pymetrics/audit-ai | AI and Machine Learning, Python |
| Probabilistic-Programming-and-Bayesian-Methods-for-Hackers | aka "Bayesian Methods for Hackers": An introduction to Bayesian methods + probabilistic programming with a computation/understanding-first, mathematics-second point of view. All in pure Python ;) | https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers | AI and Machine Learning, Python |
| snorkel | A system for quickly generating training data with weak supervision | https://github.com/snorkel-team/snorkel | AI and Machine Learning, Python |
| cheatsheets-ai | Essential Cheat Sheets for deep learning and machine learning researchers https://medium.com/@kailashahirwar/essential-cheat-sheets-for-machine-learning-and-deep-learning-researchers-efb6a8ebd2e5 | https://github.com/kailashahirwar/cheatsheets-ai | Educational Resources, AI and Machine Learning |
| mordecai | Full text geoparsing as a Python library | https://github.com/openeventdata/mordecai | Data Management, Python |
| GKG-Themes | The keywords used to generate themes for the GDELT Global Knowledge Graph. | https://github.com/ahalterman/GKG-Themes | Data Management, Python |
| face-alignment | :fire: 2D and 3D Face alignment library build using pytorch | https://github.com/1adrianb/face-alignment | AI and Machine Learning, Python, Framework |
| appium | Cross-platform automation framework for all kinds of apps, built on top of the W3C WebDriver protocol | https://github.com/appium/appium | Mobile Development, DevOps |
| textacy | NLP, before and after spaCy | https://github.com/chartbeat-labs/textacy | Natural Language Processing |
| sonic-pi | Code. Music. Live. | https://github.com/sonic-pi-net/sonic-pi | AI and Machine Learning |
| luminoth | Deep Learning toolkit for Computer Vision. | https://github.com/tryolabs/luminoth | AI and Machine Learning |
| react-native-charts-wrapper | a react native charts wrapper (support android & iOS) | https://github.com/wuxudong/react-native-charts-wrapper | Mobile Development, React |
| titus |  | https://github.com/Netflix/titus | System Management |
| mobx-decorators | Several helper MobX decorators (setter, observe, save, ...) | https://github.com/farwayer/mobx-decorators | JavaScript |
| mobx-state-tree | Full-featured reactive state management without the boilerplate | https://github.com/mobxjs/mobx-state-tree | JavaScript |
| devtools-frontend | The Chrome DevTools UI | https://github.com/ChromeDevTools/devtools-frontend | Development Tools |
| web-scraper-chrome-extension | Web data extraction tool implemented as chrome extension | https://github.com/martinsbalodis/web-scraper-chrome-extension | Web Development, Browser and Extensions |
| websockhop | Network resilient WebSocket wrapper | https://github.com/fanout/websockhop | Networking and Communication |
| ftdomdelegate | Create and manage a DOM event delegator | https://github.com/Financial-Times/ftdomdelegate | JavaScript, Web Development |
| dumb-init | A minimal init system for Linux containers | https://github.com/Yelp/dumb-init | System Management, DevOps |
| rsmq | Redis Simple Message Queue | https://github.com/smrchy/rsmq | JavaScript, Data Management |
| rsmq-worker | Helper to simply implement a worker around RSMQ ( Redis Simple Message Queue ) | https://github.com/mpneuried/rsmq-worker | JavaScript, Data Management |
| node-portastic | Find open ports programmatically with Node.js | https://github.com/alanhoff/node-portastic | JavaScript, Networking and Communication |
| mididings-arpeggiator | An arpeggio generator which is easy to use and customize for achieving fabulous patterns | https://github.com/webpolis/mididings-arpeggiator | Python, Music Generation |
| typedoc | Documentation generator for TypeScript projects. | https://github.com/TypeStrong/typedoc | TypeScript, Development Tools |
| magenta | Magenta: Music and Art Generation with Machine Intelligence | https://github.com/magenta/magenta | AI and Machine Learning, Music Generation |
| AutoSploit | Automated Mass Exploiter | https://github.com/NullArray/AutoSploit | Security and Privacy, Penetration Testing |
| awesome-scalability | The Patterns of Scalable, Reliable, and Performant Large-Scale Systems | https://github.com/binhnguyennus/awesome-scalability | Development Tools, System Management |
| docker-elk | The Elastic stack (ELK) powered by Docker and Compose. | https://github.com/deviantony/docker-elk | Docker, ELK Stack |
| logjam | a log shipping tool | https://github.com/gocardless/logjam | Utility, Log Management |
| awesome-docker | :whale: A curated list of Docker resources and projects | https://github.com/veggiemonk/awesome-docker | Docker, Resources |
| mastodon | Your self-hosted, globally interconnected microblogging community | https://github.com/mastodon/mastodon | Web Development, Social Media |
| predictionio | PredictionIO, a machine learning server for developers and ML engineers. | https://github.com/apache/predictionio | AI and Machine Learning, Server |
| Learn-Pandas | Tutorials on how to use pandas effectively to do data analysis | https://github.com/tdpetrou/Learn-Pandas | Educational Resources, Data Analysis |
| turicreate | Turi Create simplifies the development of custom machine learning models. | https://github.com/apple/turicreate | AI and Machine Learning, Framework |
| parcel | The zero configuration build tool for the web. 📦🚀 | https://github.com/parcel-bundler/parcel | Web Development, Build Tool |
| sent2vec | General purpose unsupervised sentence representations | https://github.com/epfml/sent2vec | AI and Machine Learning, NLP |
| spacy-api-docker | spaCy REST API, wrapped in a Docker container. | https://github.com/jgontrum/spacy-api-docker | Docker, NLP |
| math-as-code | a cheat-sheet for mathematical notation in code form | https://github.com/Experience-Monks/math-as-code | Utility |
| nock | HTTP server mocking and expectations library for Node.js | https://github.com/nock/nock | JavaScript, Development Tools |
| rasa | 💬 Open source machine learning framework to automate text- and voice-based conversations: NLU, dialogue management, connect to Slack, Facebook, and more - Create chatbots and voice assistants | https://github.com/RasaHQ/rasa | AI and Machine Learning, Python |
| grumbler | A template for writing distributable front-end javascript modules. | https://github.com/krakenjs/grumbler | JavaScript, Web Development |
| cosmos | World's largest Contributor driven code dataset | Used in Quark Search Engine, @OpenGenus IQ, OpenGenus Visual Project | Data Management |
| node-xvfb |  | https://github.com/Rob--W/node-xvfb | System Management |
| xvfb-record |  | https://github.com/grayleonard/xvfb-record | System Management |
| kue | Kue is a priority job queue backed by redis, built for node.js. | https://github.com/Automattic/kue | JavaScript, Development Tools |
| p-queue | Promise queue with concurrency control | https://github.com/sindresorhus/p-queue | JavaScript, Development Tools |
| LokiJS | javascript embeddable / in-memory database | https://github.com/techfort/LokiJS | JavaScript, Data Management |
| incuator-weex | Apache Weex (Incubating) | https://github.com/apache/incubator-weex | Web Development |
| exa | A modern replacement for ‘ls’. | https://github.com/ogham/exa | Development Tools |
| Awesome-Linux-Software | 🐧 A list of awesome Linux softwares | https://github.com/luong-komorebi/Awesome-Linux-Software | Productivity Tools |
| BlockchainStore | :moneybag: Retail Store that runs on Ethereum | https://github.com/brakmic/BlockchainStore | Cryptography and Blockchain |
| raiden | Raiden Network | https://github.com/raiden-network/raiden | Networking and Communication |
| clay | Golem is creating a global market for computing power. | https://github.com/golemfactory/clay | AI and Machine Learning |
| saul | Experimental annotation-based javascript unit tests :rocket: | https://github.com/nadeesha/saul | Javascript |
| pretty-algorithms | 🌊 Pretty, common and useful algorithms with modern JS and beautiful tests | https://github.com/jiayihu/pretty-algorithms | Javascript |
| caffe | Caffe: a fast open framework for deep learning. | https://github.com/weiliu89/caffe | AI and Machine Learning |
| dcgan_code | Deep Convolutional Generative Adversarial Networks | https://github.com/Newmu/dcgan_code | AI and Machine Learning |
| react-bits | ✨ React patterns, techniques, tips and tricks ✨ | https://github.com/vasanthk/react-bits | React |
| chromeless | 🖥 Chrome automation made simple. Runs locally or headless on AWS Lambda. | https://github.com/schickling/chromeless | Development Tools |
| jest | Delightful JavaScript Testing. | https://github.com/jestjs/jest | JavaScript |
| micro | Asynchronous HTTP microservices | https://github.com/vercel/micro | Web Development |
| rotating-proxy | Rotating TOR proxy with Docker | https://github.com/mattes/rotating-proxy | DevOps, Docker |
| onion | Tor networking plugin for Docker containers. Route all container tcp traffic through Tor. | https://github.com/jessfraz/onion | Networking and Communication, Docker |
| infernal-twin | wireless hacking - This is automated wireless hacking tool | https://github.com/entropy1337/infernal-twin | Security and Privacy |
| ossec-hids | OSSEC is an Open Source Host-based Intrusion Detection System that performs log analysis, file integrity checking, policy monitoring, rootkit detection, real-time alerting and active response. | https://github.com/ossec/ossec-hids | Security and Privacy |
| magic-wormhole | get things from one computer to another, safely | https://github.com/magic-wormhole/magic-wormhole | Networking and Communication |
| express-throttle | Request throttling middleware for Express | https://github.com/Nullmage/express-throttle | Web Development |
| jsinspect | Detect copy-pasted and structurally similar code | https://github.com/danielstjules/jsinspect | Code Analysis, JavaScript |
| spotifyripper | small ripper script for spotify (rips playlists to mp3 and includes ID3 tags and album covers) | https://github.com/robbeofficial/spotifyripper | Media Tools, Audio Processing |
| GloVe | Software in C and data files for the popular GloVe model for distributed word representations, a.k.a. word vectors or embeddings | https://github.com/stanfordnlp/GloVe | AI and Machine Learning, Natural Language Processing |
| sense2vec | 🦆 Contextually-keyed word vectors | https://github.com/explosion/sense2vec | AI and Machine Learning, Natural Language Processing |
| spaCy | 💫 Industrial-strength Natural Language Processing (NLP) in Python | https://github.com/explosion/spaCy | AI and Machine Learning, Natural Language Processing, Python |
| ghindex | Creates github index for similar repositories discovery | https://github.com/anvaka/ghindex | Development Tools, Repository Management |
| duka | duka - Dukascopy historical data downloader | https://github.com/giuse88/duka | Data Management, Financial Tools |
| ignite | Infinite Red's battle-tested React Native project boilerplate, along with a CLI, component/model generators, and more! | https://github.com/infinitered/ignite | Mobile Development, React |
| plato | JavaScript source code visualization, static analysis, and complexity tool | https://github.com/es-analysis/plato | Code Analysis, JavaScript |
| jsnice | Command line interface to http://jsnice.org. | https://github.com/brettlangdon/jsnice | Development Tools, CLI Tool |
| gdb-imshow | GDB extension to show OpenCV images | https://github.com/renatoGarcia/gdb-imshow | Python, OpenCV, Development Tools |
| mineye | reverse image search engine in opencv | https://github.com/dlau/mineye | Python, OpenCV, Web Development |
| livekeys | Livekeys - Automation Platform with support for live scripting. | https://github.com/live-keys/livekeys | JavaScript, Automation, Productivity Tools |
| sharingan | Tool to extract news articles from newspaper and give the context about the news | https://github.com/vipul-sharma20/sharingan | Python, Web Scraping, Utility |
| bgslibrary | A C++ Background Subtraction Library with wrappers for Python, MATLAB, Java and GUI on QT | https://github.com/andrewssobral/bgslibrary | C++, Python, MATLAB, Computer Vision |
| AutoRCCar | OpenCV Python Neural Network Autonomous RC Car | https://github.com/hamuchiwa/AutoRCCar | Python, OpenCV, AI and Machine Learning |
| face_classification | Real-time face detection and emotion/gender classification using fer2013/imdb datasets with a keras CNN model and openCV. | https://github.com/oarriaga/face_classification | Python, OpenCV, AI and Machine Learning |
| awesome-public-datasets | A topic-centric list of HQ open datasets. | https://github.com/awesomedata/awesome-public-datasets | Data Management, Educational Resources |
| gensim | Topic Modelling for Humans | https://github.com/piskvorky/gensim | Python, Natural Language Processing |
| aubio | a library for audio and music analysis | https://github.com/aubio/aubio | C++, Audio Processing, Development Tools |
| essentia | C++ library for audio and music analysis, description and synthesis, including Python bindings | https://github.com/MTG/essentia | C++, Audio Analysis, Library |
| gun | An open source cybersecurity protocol for syncing decentralized graph data. | https://github.com/amark/gun | JavaScript, Cybersecurity, Protocol |
| mtcnn-caffe | Joint Face Detection and Alignment using Multi-task Cascaded Convolutional Neural Networks | https://github.com/CongWeilin/mtcnn-caffe | Python, Computer Vision, Neural Networks |
| person_search | Joint Detection and Identification Feature Learning for Person Search | https://github.com/ShuangLI59/person_search | Python, Machine Learning, Computer Vision |
| mididings | A MIDI router/processor based on Python | https://github.com/dsacre/mididings | Python, MIDI, Router |
| miditime | Generate MIDI files from time series data. You can control what octaves and octave ranges you want. | https://github.com/cirlabs/miditime | Python, MIDI, File Generation |
| Midi-AI-Melody-Generator | Uses LSTM neural networks to compose new and original melodies by feeding it midi files | https://github.com/vanstorm9/Midi-AI-Melody-Generator | Python, AI, Music Generation |
| word2vec | Distributed Representation of Words | https://github.com/beniz/word2vec | Python, Natural Language Processing, Machine Learning |
| thingscoop | Search and filter videos based on objects that appear in them using convolutional neural networks | https://github.com/agermanidis/thingscoop | Python, Computer Vision, Video Analysis |
| object-detection | Real-time anomaly object detection. | https://github.com/ninearif/object-detection | Python, Computer Vision, Object Detection |
| biaxial-rnn-music-composition | A recurrent neural network designed to generate classical music. | https://github.com/danieldjohnson/biaxial-rnn-music-composition | AI and Machine Learning, Python |
| neural-doodle | Turn your two-bit doodles into fine artworks with deep neural networks, generate seamless textures from photos, transfer style from one image to another, perform example-based upscaling, but wait... there's more! (An implementation of Semantic Style Transfer.) | https://github.com/alexjc/neural-doodle | AI and Machine Learning, Python |
| deepdetect | Deep Learning API and Server in C++14 support for Caffe, PyTorch, TensorRT, Dlib, NCNN, Tensorflow, XGBoost and TSNE | https://github.com/jolibrain/deepdetect | AI and Machine Learning, C++ |
| caffe | Caffe: a fast open framework for deep learning. | https://github.com/BVLC/caffe | AI and Machine Learning, C++ |
| artos | Adaptive Real-Time Object Detection System with HOG and CNN Features | https://github.com/cvjena/artos | AI and Machine Learning, C++ |
| OpenCvandCaffeModel |  | https://github.com/IrvingShu/OpenCvandCaffeModel | AI and Machine Learning, C++ |
| InceptionBN-21K-for-Caffe | Inception-BN ImageNet (21K classes) model for Caffe | https://github.com/pertusa/InceptionBN-21K-for-Caffe | AI and Machine Learning, C++ |
| SOD | A Method for Unconstrained Salient Object Detection | https://github.com/jimmie33/SOD | AI and Machine Learning, C++ |
| FastAnnotationTool | A tool using OpenCV to annotate images for image classification, optical character reading, ... | https://github.com/christopher5106/FastAnnotationTool | AI and Machine Learning, Python |
| openpose | OpenPose: Real-time multi-person keypoint detection library for body, face, hands, and foot estimation | https://github.com/CMU-Perceptual-Computing-Lab/openpose | AI and Machine Learning, C++ |
| captcha-break | captcha break based on opencv2, tesseract-ocr and some machine learning algorithm. | https://github.com/nladuo/captcha-break | Python, OpenCV, Tesseract, Machine Learning |
| websocket-webcam | A pure javascript HTML5 webcam client using websockets to stream the image | https://github.com/wgroeneveld/websocket-webcam | JavaScript, WebSockets, Web Development |
| NTOU-CS-OpenCV.HW | HomeWork | https://github.com/NatLee/NTOU-CS-OpenCV.HW | OpenCV |
| localtunnel | expose yourself | https://github.com/localtunnel/localtunnel | Node.js, Development Tools |
| Nodejs-Stanford-Classifier | Nodejs wrapper for Stanford Classifier. | https://github.com/mbejda/Nodejs-Stanford-Classifier | Node.js, Machine Learning |
| clean-code-javascript | :bathtub: Clean Code concepts adapted for JavaScript | https://github.com/ryanmcdermott/clean-code-javascript | JavaScript, Development Tools |
| wuzz | Interactive cli tool for HTTP inspection | https://github.com/asciimoo/wuzz | CLI Tool, Development Tools |
| truffle | :warning: The Truffle Suite is being sunset. For information on ongoing support, migration options and FAQs, visit the Consensys blog. Thank you for all the support over the years. | https://github.com/trufflesuite/truffle | Ethereum, Development Tools |
| embark | Framework for serverless Decentralized Applications using Ethereum, IPFS and other platforms | https://github.com/embarklabs/embark | Ethereum, IPFS, Framework |
| go-ethereum | Go implementation of the Ethereum protocol | https://github.com/ethereum/go-ethereum | Go, Ethereum |
| ethereumjs-lib | [DEPRECATED] A JavaScript library of core Ethereum functions | https://github.com/ethereumjs/ethereumjs-lib | JavaScript, Ethereum |
| react-webpack-seed | A simple seed for an app with react and webpack | https://github.com/marcio/react-webpack-seed | React, Web Development |
| react-native-device-info | Device Information for React Native iOS and Android | https://github.com/react-native-device-info/react-native-device-info | React Native, Mobile Development |
| djinni | A tool for generating cross-language type declarations and interface bindings. | https://github.com/dropbox/djinni | Development Tools |
| react-native-social-share | Use the iOS and Android native Twitter and Facebook share popup with React Native | https://github.com/doefler/react-native-social-share | React Native, Mobile Development |
| react-native-push-notification | React Native Local and Remote Notifications | https://github.com/zo0r/react-native-push-notification | React Native, Mobile Development |
| react-native-android-sms-listener | Allows you to listen for incoming SMS messages using React Native | https://github.com/andreyvital/react-native-android-sms-listener | React Native, Mobile Development |
| react-native-message-bar | A notification bar alert displayed at the top of the screen for react-native | https://github.com/KBLNY/react-native-message-bar | React Native, Mobile Development |
| react-native-vector-icons | Customizable Icons for React Native with support for image source and full styling. | https://github.com/oblador/react-native-vector-icons | React Native, Mobile Development |
| react-native-geo-fencing | Native modules to determine if a location is within defined geographical boundaries using Google Geometry library | https://github.com/surialabs/react-native-geo-fencing | React Native, Mobile Development |
| react-native-gifted-listview | ✌️ ListView with pull-to-refresh and infinite scrolling for Android and iOS React-Native apps | https://github.com/FaridSafi/react-native-gifted-listview | React, Mobile Development |
| react-native-gifted-form     | 📝 « One React-Native form component to rule them all » | https://github.com/FaridSafi/react-native-gifted-form | React, Mobile Development |
| react-native-gifted-chat     | 💬 The most complete chat UI for React Native | https://github.com/FaridSafi/react-native-gifted-chat | React, Mobile Development |
| most                         | Ultra-high performance reactive programming | https://github.com/cujojs/most | JavaScript, Development Tools |
| angular2-grid                | A drag/drop/resize grid-based plugin directive for angular2 | https://github.com/BTMorton/angular2-grid | Angular, Web Development |
| ngx-admin                    | Customizable admin dashboard template based on Angular 10+ | https://github.com/akveo/ngx-admin | Angular, Web Development |
| opencog                      | A framework for integrated Artificial Intelligence & Artificial General Intelligence (AGI) | https://github.com/opencog/opencog | AI and Machine Learning |
| electron                     | :electron: Build cross-platform desktop apps with JavaScript, HTML, and CSS | https://github.com/electron/electron | JavaScript, Development Tools |
| universe-modules             | Use ES6 / ES2015 modules in Meteor with SystemJS | https://github.com/vazco/universe-modules | JavaScript, Development Tools |
| universe-ecmascript          | Supports ES2015+ in all .js files with modules | https://github.com/vazco/universe-ecmascript | JavaScript, Development Tools |
| EaselJS | The Easel Javascript library provides a full, hierarchical display list, a core interaction model, and helper classes to make working with the HTML5 Canvas element much easier. | https://github.com/CreateJS/EaselJS | JavaScript, Web Development, Canvas |
| GSAP | GSAP (GreenSock Animation Platform), a JavaScript animation library for the modern web | https://github.com/greensock/GSAP | JavaScript, Web Development, Animation |
| find-object | Find-Object project | https://github.com/introlab/find-object | JavaScript, Utility |
| micron-throttle | Token bucket based HTTP request throttle for Node.js | https://github.com/thisandagain/micron-throttle | JavaScript, Node.js, Utility |
| d3 | Bring data to life with SVG, Canvas and HTML. :bar_chart::chart_with_upwards_trend::tada: | https://github.com/d3/d3 | JavaScript, Data Management, Visualization |
| ngSticky | AngularJS directive to make elements stick when scrolling down. | https://github.com/d-oliveros/ngSticky | JavaScript, Angular, Web Development |
| confess | [ARCHIVED] Uses PhantomJS to headlessly analyze web pages and generate manifests. You may be able to use the puppeteer-har package instead. | https://github.com/jamesgpearce/confess | JavaScript, Web Development, Automation |
| grunt-uncss | :scissors: A grunt task for removing unused CSS from your projects. | https://github.com/uncss/grunt-uncss | JavaScript, Development Tools, CSS |
| supertest | 🕷 Super-agent driven library for testing node.js HTTP servers using a fluent API. Maintained for @forwardemail, @ladjs, @spamscanner, @breejs, @cabinjs, and @lassjs. | https://github.com/ladjs/supertest | JavaScript, Node.js, Testing |
| JSONPath | A fork of JSONPath from http://goessner.net/articles/JsonPath/ | https://github.com/JSONPath-Plus/JSONPath | JavaScript, Data Management |
| StockScraper | retrieves Yahoo Finance stock information using YQL | https://github.com/gurch101/StockScraper | Data Management |
| Lyric | Linear Regression library in pure Javascript | https://github.com/flurry/Lyric | JavaScript |
| node-quandl | A nodejs module for interacting with the Quandl API. | https://github.com/normanjoyner/node-quandl | API, JavaScript |
| mindread | Cross platform Serial Port parser for ThinkGear Mindset protocol | https://github.com/webpolis/mindread | System Management |
| mindset-js-binary-parser | A nodejs module for parsing binary data for Mindset by Neurosky | https://github.com/dkulichkin/mindset-js-binary-parser | JavaScript |
| twimpress | An angularjs-based data visualizer for Mindset/Minwave by Neurosky. Exposes all charts and might be used for bootstrapping new projects. A sandbox part performs evaluation of rotating twitter accounts with the latest posts grabbed by query, based on average attention metric detected over 65/100 | https://github.com/dkulichkin/twimpress | Angular, Data Management |
| node-neurosky | A Node.js client library for the ThinkGear Socket Protocol from NeuroSky | https://github.com/dluxemburg/node-neurosky | JavaScript, API |
| node-bluetooth-serial-port | Serial I/O over bluetooth for NodeJS | https://github.com/eelcocramer/node-bluetooth-serial-port | System Management, JavaScript |
| Brain | Arduino library for reading Neurosky EEG brainwave data. (Tested with the MindFlex and Force Trainer toys.) | https://github.com/kitschpatrol/Brain | Arduino, Data Management |
| angular-treecursive | Customizable recursive tree for Angular | https://github.com/webpolis/angular-treecursive | Angular |
